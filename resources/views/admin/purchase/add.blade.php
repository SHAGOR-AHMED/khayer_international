                ...
                <div class="box box-warning">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <a href="{{ route('purchase.index') }}" class="btn btn-success btn-sm" style="margin-left: 250px;"><i
                            ...
                            <div class="row">
                                <div style="padding: 10px;">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label for="Name">Money Receipt No</label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" id="userfile" class="form-control" name="image" value=""
                                                onchange="getPreview('userfile','img_preview','none');">
                                ...
                                <div style="padding: 10px;">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="product_details"
                                                placeholder="Enter Details" value="" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <span
                                                class="text-danger">{{ $errors->has('product_quantity') ? $errors->first('product_quantity') : '' }}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="product_price" id="product_price"
                                                ...
                                                onkeyup="productQty()" ondrop="return false;" onpaste="return false;">
                                            <span
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="product_total_amount"
                                                id="product_total_amount" value="" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="bdamount" id="bdamount"
                                                placeholder="Enter BD Amount" value="" ondrop="return false;" onpaste="return false;" onkeyup="rateConversion()">
                                            <span
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="payrate" id="payrate"
                                                placeholder="Enter Rate" value="" ondrop="return false;" onpaste="return false;" onkeyup="rateConversion()">
                                            <span
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="amount" id="amount"
                                                placeholder="Enter Amount" value="{{ old('amount') }}" required readonly>
                                            <span
