        ...
        <table class="table" style="vertical-align: top">
            <tbody>            
                <tr>
                    ...
                    <td> 
                        <p> <?php echo " : " . $supplier->office_name; ?> </p>
                ...
                <?php
                    ...
                    foreach ($results as $row) {
                        ...
                        if ($i == 1 && $row->transaction_type == 'Initial Balance') {
                            ...
                            if ($i == 1) {
                                // Get previous blance
                                $balance = app(\App\Http\Controllers\Admin\Supplier\IndexController::class)->previous_blance($supplier->id, $from_date);
                                echo "<tr>";
                            ...
                            echo "<tr>";
                                ...
                                echo "<td valign='top'>" . $row->billing_date . "</td>";
