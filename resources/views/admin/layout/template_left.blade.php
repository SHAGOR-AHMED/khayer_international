...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                <a href="javascript:">
                    <i class="fa fa-users fa-lg"></i> <span>Agent Module</span> <i
            ...
            <li class="treeview">
                <a href="javascript:">
                    <i class="fa fa-users fa-lg"></i> <span>Supplier Module</span> <i
                        class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
            ...
            <li class="treeview">
                <a href="javascript:">
                    <i class="fa fa-users fa-lg"></i> <span>Passenger Module</span> <i
                        class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
            ...
            <li class="treeview">
                <a href="javascript:">
                    <i class="fa fa-list fa-lg"></i> <span>Entry Module</span> <i
                        class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
            ...
            <li class="treeview">
                <a href="javascript:">
                    <i class="fa fa-university fa-lg"></i> <span>Embassy Module</span> <i
                        class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
            ...
            <li class="treeview">
                <a href="javascript:">
                    <i class="fa fa-cog fa-lg"></i> <span>Manpower Module</span> <i
                        class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
            ...
            <li class="treeview">
                <a href="javascript:">
                    <i class="fa fa-delicious fa-lg"></i> <span>Delivery Module</span> <i
                        class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
            ...
            <li class="treeview">
                <a href="javascript:">
                    <i class="fa fa-users fa-lg"></i> <span>Purchase Module</span> <i
                        class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
            ...
            <li class="treeview">
                <a href="javascript:">
                    <i class="fa fa-calculator fa-lg"></i> <span>Accounts Module</span> <i
                        class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="{{ route('bank.ledger') }}"><i class="fa fa-bar-chart"></i>Bank & Cash Ledger</a></li>
                </ul>
            </li>

            <li class="treeview">
                <a href="javascript:">
                    <i class="fa fa-wrench fa-lg"></i> <span>Administration Module</span> <i
                        class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
